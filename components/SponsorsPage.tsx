...
export function SponsorsPage({
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">
            You don't have permission to access the Sponsor Management page.
          </p>
          <Button
  ...
  const sponsorStats = {
    ...
    totalValue: sponsors
      ...
      .reduce((sum, s) => sum + s.sponsorshipAmount, 0),
    tiers: {
      Premium: sponsors.filter((s) => s.tier === "Premium" && !s.isArchived)
        .length,
      Gold: sponsors.filter((s) => s.tier === "Gold" && !s.isArchived).length,
      Silver: sponsors.filter((s) => s.tier === "Silver" && !s.isArchived)
        .length,
      Bronze: sponsors.filter((s) => s.tier === "Bronze" && !s.isArchived)
        .length,
    },
  };
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {formatCurrency(sponsorStats.totalValue)}
                </div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {sponsorStats.total > 0
                    ? Math.round(
                        (sponsorStats.active / sponsorStats.total) * 100
                      )
                    : 0}
                  %
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Distribution of sponsors across different tiers
                </CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="w-32 bg-gray-200 rounded-full h-2">
                          <div
                            ...
                            style={{
                              width: `${sponsorStats.total > 0 ? (count / sponsorStats.total) * 100 : 0}%`,
                            }}
                          ></div>
                        </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {Object.entries(sponsorStats.tiers).map(([tier, count]) => {
                    ...
                    const percentage =
                      sponsorStats.totalValue > 0
                        ? (tierRevenue / sponsorStats.totalValue) * 100
                        : 0;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Latest sponsor partnerships and updates
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
