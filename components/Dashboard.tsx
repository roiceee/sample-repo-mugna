...
export function Dashboard({ user, onNavigate }: DashboardProps) {
  ...
  const sponsors: Sponsor[] = [
    {
      ...
      tier: "platinum",
      description:
        "Premier sports facility providing world-class training equipment and venues for DSRFA events.",
    ...
    },
    {
      ...
      tier: "platinum",
      description:
        "Leading sportswear brand providing official uniforms and equipment for all DSRFA teams.",
    ...
    },
    {
      ...
      tier: "gold",
      description:
        "Regional banking partner supporting grassroots football development and financial literacy programs.",
    ...
    },
    {
      ...
      tier: "gold",
      description:
        "Local market chain providing healthy nutrition options and meal sponsorships for events.",
    ...
    },
    {
      ...
      tier: "silver",
      description:
        "Technology company providing digital solutions for event management and live streaming.",
    ...
    },
    {
      ...
      tier: "silver",
      description:
        "Transportation company providing team travel and logistics support for away games.",
  ...
  const announcements = [
    {
      ...
      message:
        "We're excited to announce the opening of our new state-of-the-art training facility next month.",
      date: "2025-06-10",
      priority: "high",
    },
    {
      ...
      message:
        "Annual membership renewals are due by the end of this month. Renew now to avoid service interruption.",
      date: "2025-06-08",
      priority: "medium",
    },
  ];
  ...
  const membershipDaysLeft = Math.ceil(
    (new Date(user.membershipExpiry).getTime() - new Date().getTime()) /
      (1000 * 60 * 60 * 24)
  );
            ...
            <CardContent>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`text-sm font-medium ${membershipDaysLeft < 30 ? "text-red-600" : "text-green-600"}`}
                  >
                ...
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                      <Badge
                        className={`${getTierInfo(selectedSponsor.tier).color} ${getTierInfo(selectedSponsor.tier).textColor} rounded-lg`}
                      >
                        {getTierInfo(selectedSponsor.tier).icon}
                        <span className="ml-2">
                          {getTierInfo(selectedSponsor.tier).label}
                        </span>
                      </Badge>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="font-semibold mb-3">
                    Benefits & Contributions to DSRFA
                  </h4>
