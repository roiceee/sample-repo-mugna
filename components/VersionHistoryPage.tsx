  ...
  const versionHistory: VersionEntry[] = [
    {
      ...
      components: ["/components/ProfilePage.tsx"],
      categories: {
        "User Interface": [
    ...
    },
    {
      ...
      components: ["/components/AddSponsorPage.tsx", "/App.tsx"],
      categories: {
        "User Interface": [
    ...
    },
    {
      ...
      components: ["/components/SponsorsPage.tsx", "/App.tsx"],
      categories: {
        "User Interface": [
    ...
    },
    {
      ...
      components: ["/components/RenewalPage.tsx"],
      categories: {
        "User Interface": [
    ...
    },
    {
      ...
      components: ["/components/LoginPage.tsx"],
      categories: {
        "Core Features": [
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <Badge
                    className={`${getTypeColor(version.type)} text-white flex items-center space-x-1`}
                  >
              ...
              <Accordion type="multiple" className="space-y-2">
                {Object.entries(version.categories).map(([category, items]) => (
                  <AccordionItem
                    key={category}
                    value={category}
                    className="border-none shadow-none bg-gray-100 rounded-lg"
                  >
