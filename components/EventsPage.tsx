...
export function EventsPage({ user, onNavigate }: EventsPageProps) {
  ...
  const [events, setEvents] = useState<Event[]>([
    {
      ...
      description:
        "The ultimate showdown for youth teams across the region. Come witness the future stars of football compete for the championship title.",
      date: "2025-06-20",
      time: "14:00",
    ...
    },
    {
      ...
      description:
        "Official referee certification program. Learn the rules, regulations, and practical skills needed to officiate matches.",
      date: "2025-06-25",
      time: "10:00",
    ...
    },
    {
      ...
      description:
        "Exciting match between the top two teams in the women's league. Come support our female athletes!",
      date: "2025-06-18",
      time: "16:00",
    ...
    },
    {
      ...
      description:
        "Interactive workshop focusing on fundamental football skills for young players aged 8-14.",
      date: "2025-06-22",
      time: "11:00",
    ...
    },
    {
      ...
      description:
        "Professional development seminar for coaches covering modern training techniques and sports psychology.",
      date: "2025-06-30",
      time: "13:00",
  ...
  const filteredEvents = events.filter((event) => {
    ...
    const matchesAgeGroup =
      selectedAgeGroup === "all" || event.ageGroup === selectedAgeGroup;
    const matchesLocation =
      selectedLocation === "all" || event.location === selectedLocation;

    return (
      matchesSearch && matchesCategory && matchesAgeGroup && matchesLocation
    );
  });
    ...
    <div className="container mx-auto px-4 py-8">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleFormChange("registrationFee", e.target.value)
                        }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredEvents.map((event) => (
          <Card
            key={event.id}
            className="overflow-hidden hover:shadow-lg transition-shadow rounded-lg"
          >
            <div
