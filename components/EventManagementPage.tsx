...
export function EventManagementPage({
  ...
  const mockEvents: Record<string, Event> = {
    "1": {
      ...
      description:
        "Annual regional championship tournament featuring teams from across Mindanao.",
      date: "2025-07-15",
      time: "09:00",
      location: "Davao City",
      ...
      participants: [
        ...
        },
        {
          ...
          paymentProofImage:
            "https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=300&h=400&fit=crop",
          approvalStatus: "Pending",
        },
        {
          id: "p5",
        ...
        },
        {
          ...
          paymentProofImage:
            "https://images.unsplash.com/photo-1633158829585-23ba8f7c8caf?w=300&h=400&fit=crop",
          approvalStatus: "Approved",
        },
        {
          id: "p7",
        ...
        },
        {
          ...
          paymentProofImage:
            "https://images.unsplash.com/photo-1554224154-26032fced8bd?w=300&h=400&fit=crop",
          approvalStatus: "Approved",
        },
        {
          id: "p9",
    ...
    "2": {
      ...
      description:
        "Comprehensive training workshop for young players and coaches.",
      date: "2025-06-30",
      time: "14:00",
  ...
  const handleParticipantApproval = (
    ...
    if (participant) {
      alert(
        `${participant.name} has been ${action === "approve" ? "approved" : "declined"} for the event.`
      );
    }
  };
  ...
  const handleDownloadPaymentProof = (
    ...
    console.log(
      `Downloading payment proof for ${participantName}: ${imageUrl}`
    );
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Manage participants and track event performance
            </p>
          </div>
        </div>
      </div>
                                  ...
                                  <DialogContent className="max-w-md">
                                    <DialogHeader>
                                      ...
                                      <DialogDescription>
                                        ...
                                        submitted by {participant.name} for this
                                        event registration.
                                      </DialogDescription>
                                    </DialogHeader>
