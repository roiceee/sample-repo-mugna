...
export function EventRegistrationPage({
  ...
  const event: Event = {
    ...
    description:
      "Intensive 5-day training program designed to improve your skills and fitness. Suitable for all skill levels with professional coaching.",
    date: "2025-07-01",
    time: "09:00",
  ...
  const getClubPlayers = (): ClubPlayer[] => {
    ...
    return allRegisteredMembers.filter(
  ...
  const availablePlayers = clubPlayers.filter(
    (player) => player.membershipStatus === "Active"
  );
  ...
  const handleJerseyNumberChange = (playerId: string, jerseyNumber: string) => {
    setSelectedPlayers((prev) =>
      prev.map((p) =>
        p.playerId === playerId
          ? { ...p, jerseyNumber: parseInt(jerseyNumber) || undefined }
          : p
      )
    );
  };
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-6">
            ...
            {isClubOwner &&
              ` You have registered ${selectedPlayers.length + 1} participants.`}
          </p>
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              ...
              {isClubOwner && (
                <li>
                  • All team members will receive individual confirmations
                </li>
              )}
            </ul>
          </div>
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <Badge className="mt-1 bg-logo-green text-white">
                              Club Owner (Auto-registered)
                            </Badge>
                          </div>
                        </div>
                      ...
                      <div className="mb-4">
                        ...
                        <Select
                          onValueChange={(playerId) =>
                            handlePlayerSelection(playerId, true)
                          }
                        >
                            ...
                            {selectedPlayers.map((selectedPlayer) => {
                              ...
                              return (
                                <div
                                  ...
                                  className="p-4 border rounded-lg border-logo-green bg-green-50"
                                >
                                  <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                      <Avatar className="w-10 h-10">
                    ...
                    {selectedPlayers.length === 0 && (
                      <Alert>
                        ...
                        <AlertDescription>
                          You are automatically registered as Team Manager. Use
                          the dropdown above to add additional players from your
                          club ({user?.club}) to this event.
                        </AlertDescription>
                      </Alert>
                    )}
                  </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-blue-800">
                                Account Name: <strong>DSRFA Events</strong>
                              </p>
                      ...
                      <Alert>
                        <AlertCircle className="h-4 w-4" />
                        <AlertDescription>
                          Your registration will be confirmed once payment is
                          verified (usually within 24 hours). You will receive
                          email confirmation upon successful verification.
                        </AlertDescription>
                      </Alert>
                    </div>
                  </CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      Your registration will be confirmed once payment is
                      verified (usually within 24 hours). You will receive email
                      confirmation upon successful verification.
                    </AlertDescription>
                  </Alert>
                </div>
              </CardContent>
