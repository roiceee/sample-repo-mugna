...
export function RenewalPage({ user, onNavigate }: RenewalPageProps) {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4">
            Please log in to renew your membership
          </h2>
  ...
  const handleRenewal = async () => {
    ...
    setTimeout(() => {
      ...
      alert(
        `Membership renewed successfully! Your ${currentPlan?.name} is now active until ${new Date(Date.now() + 365 * 24 * 60 * 60 * 1000).toLocaleDateString()}`
      );
    }, 3000);
  };
            ...
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <Badge
                  ...
                  className={
                    user.membershipStatus === "Active" ? "bg-green-600" : ""
                  }
                >
                ...
                <div className="mt-4">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm text-gray-600">
                      {Math.max(
                        0,
                        Math.round(((365 - membershipDaysLeft) / 365) * 100)
                      )}
                      %
                    </span>
                  </div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Alert className="mt-4">
                ...
                <AlertDescription>
                  Your membership will be extended for 1 year from your current
                  expiry date.
                </AlertDescription>
              </Alert>
              ...
              >
                {isProcessing
                  ? "Processing Payment..."
                  : `Renew for ${formatPrice(currentPlan?.price || 0)}`}
              </Button>
            </CardContent>
          </Card>
