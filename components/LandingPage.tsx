...
export function LandingPage({ onNavigate }: LandingPageProps) {
  ...
  const upcomingEvents = [
    ...
    },
    {
      ...
      type: "Match",
      image:
        "https://images.unsplash.com/photo-1459865264687-595d652de67e?w=400&h=200&fit=crop&crop=center",
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=1920&h=1080&fit=crop&crop=center)",
        }}
      >
        ...
        <div className="relative container mx-auto px-4 text-center text-white">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Uniting communities through the beautiful game. Join our family of
            passionate players, dedicated coaches, and football enthusiasts in
            Davao-South Region.
          </p>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Supporting our community's passion for football
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Don't miss out on our exciting football activities
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-green-600 text-white">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Whether you're a player, coach, referee, or volunteer, there's a
            place for you in the DSRFA community.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-center">
              Select how you would like to join the Davao-South Regional
          ...
          <div className="space-y-4 mt-6">
            ...
            <Card
              className="cursor-pointer hover:border-logo-green transition-colors"
              onClick={() => {
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Register as an individual player, coach, referee, or
                      volunteer
                    </p>
                  </div>
