...
import { NavigationPage, User, isFullAdmin } from "../src/App";
...
export function AccountingPage({ user, onNavigate }: AccountingPageProps) {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">
            You don't have permission to access the Financial Management page.
          </p>
          <Button
  ...
  const recentTransactions = [
    ...
    },
    {
      id: "TXN003",
      date: "2025-06-12",
      description: "Event Registration - Youth Cup",
      type: "registration",
      amount: 150,
      category: "Events",
      status: "completed",
    },
    {
      id: "TXN004",
      date: "2025-06-11",
      description: "Venue Rental Payment",
      type: "withdrawal",
      amount: -1200,
      category: "Operations",
      status: "completed",
    },
    {
      id: "TXN005",
      date: "2025-06-11",
      description: "Training Program Fee - Advanced Course",
      type: "registration",
      amount: 300,
      category: "Training",
      status: "completed",
    },
    {
      id: "TXN006",
      date: "2025-06-10",
      description: "Coach Payment Withdrawal",
      type: "withdrawal",
      amount: -800,
      category: "Staff",
      status: "completed",
    },
    {
      id: "TXN007",
      date: "2025-06-10",
      description: "Membership Renewal - Maria Santos",
      type: "registration",
      amount: 500,
      category: "Membership",
      status: "completed",
    ...
    },
    {
      id: "TXN009",
      date: "2025-06-09",
      description: "Event Registration - Summer Camp",
      type: "registration",
      amount: 200,
      category: "Events",
      status: "completed",
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div
          className={`grid grid-cols-1 md:grid-cols-2 ${user?.role === "Admin" ? "lg:grid-cols-2" : "lg:grid-cols-4"} gap-6`}
        >
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    ₱{summary.avgMonthlyRegistrations.toLocaleString()}
                  </p>
        ...
        <Card className="rounded-lg">
          <CardHeader>
            <CardTitle>
              {user?.role === "Admin"
                ? "Registration Income Trends"
                : "Cash Flow Trends"}
            </CardTitle>
            <CardDescription>
              {user?.role === "Admin"
                ? "Monthly registration income trends"
                : "Monthly registration income vs withdrawals"}
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        {user?.role !== "Admin" && (
          <Card className="rounded-lg">
            <CardHeader>
              ...
              <CardDescription>
                Registration income vs withdrawals
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card className="rounded-lg">
          <CardHeader>
            ...
            <CardDescription>
              Filter and view all registration and withdrawal transactions
            </CardDescription>
          </CardHeader>
