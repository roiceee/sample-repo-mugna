      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="rounded-lg">
            <CardHeader>
              ...
              <CardDescription>
                Monthly membership and revenue trends
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card className="rounded-lg">
          <CardHeader>
            ...
            <CardDescription>
              Current event capacity and registration status
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                ...
                {
                  action: 'Event "Youth Championship" created',
                  user: "Admin",
                  time: "4 hours ago",
                  type: "event",
                },
                ...
                {
                  action: "Gallery updated with new photos",
                  user: "Admin",
                  time: "1 day ago",
                  type: "content",
                },
                {
                  action: "Membership renewal reminder sent",
                  user: "System",
                  time: "2 days ago",
                  type: "system",
                },
