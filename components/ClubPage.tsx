...
import { NavigationPage, User, hasAdminPrivileges } from "../src/App";
...
export function ClubPage({ user, onNavigate }: ClubPageProps) {
  ...
  const clubInfo: ClubInfo = {
    ...
    description:
      "A passionate football club dedicated to developing local talent and promoting the beautiful game in the Davao region. We believe in community, excellence, and sportsmanship.",
    achievements: [
  ...
  const handleRejection = () => {
    if (selectedMember && rejectionReason.trim()) {
      console.log(
        `Rejected member: ${selectedMember.name}, Reason: ${rejectionReason}`
      );
    ...
    return (
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Club information and team members</p>
        </div>
                  ...
                  <div className="flex flex-col md:flex-row md:items-start justify-between mb-3">
                    <div>
                      ...
                      <p className="text-gray-600">
                        {clubInfo.abbreviation} • Founded {clubInfo.founded}
                      </p>
                      <Badge className="mt-2 bg-logo-green text-white">
                        {clubInfo.category}
                      </Badge>
                    </div>
                  </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Please provide a reason for rejecting {selectedMember?.name}'s
